...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('KAdmin-Dark/images/icons/favicon.ico')}}">
    <link rel="apple-touch-icon" href="{{asset('KAdmin-Dark/images/icons/favicon.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('KAdmin-Dark/images/icons/favicon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('KAdmin-Dark/images/icons/favicon-114x114.png')}}">
    <!--Loading bootstrap css-->
    <link type="text/css" rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,400,300,700">
    <link type="text/css" rel="stylesheet" href="http://fonts.googleapis.com/css?family=Oswald:400,700,300">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/jquery-ui-1.10.4.custom.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/font-awesome.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/bootstrap.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/animate.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/all.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/main.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/style-responsive.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/zabuto_calendar.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/pace.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('KAdmin-Dark/styles/jquery.news-ticker.css')}}">
</head>
<body>
<div>
    <!--BEGIN THEME SETTING-->
            ...
            <div id="chat-box" style="top: 400px">
                ...
                <div class="chat-content">
                    <ul class="chat-box-body">
                        <li>
                            <p>
                                <img src="{{asset('KAdmin-Dark/images/avatar/128.jpg')}}" class="avt" /><span class="user">John Doe</span><span
                        ...
                        <li class="odd">
                            <p>
                                <img src="{{asset('KAdmin-Dark/images/avatar/48.jpg')}}" class="avt" /><span class="user">Swlabs</span><span
                                        class="time">09:33</span></p>
                            <p>
                            ...
                            <div class="portlet box">
                                ...
                                <div class="portlet-body">
                                    <div class="chat-scroller">
                                        <ul class="chats">
                                            <li class="in">
                                                <img src="{{asset('KAdmin-Dark/images/avatar/48.jpg')}}" class="avatar img-responsive" />
                                                <div class="message">
                                    ...
                                    <div class="profile">
                                        <div style="margin-bottom: 15px" class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4 text-center">
                                                <figure><img src="{{asset('KAdmin-Dark/images/avatar/128.jpg')}}" alt="" style="display: inline-block" class="img-responsive img-circle"/>
...
<script src="{{asset('KAdmin-Dark/script/jquery-1.10.2.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery-migrate-1.2.1.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery-ui.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/bootstrap.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/bootstrap-hover-dropdown.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/html5shiv.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/respond.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.metisMenu.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.slimscroll.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.cookie.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/icheck.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/custom.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.news-ticker.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.menu.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/pace.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/holder.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/responsive-tabs.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.categories.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.pie.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.tooltip.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.resize.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.fillbetween.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.stack.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/jquery.flot.spline.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/zabuto_calendar.min.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/index.js')}}"></script>
<!--LOADING SCRIPTS FOR CHARTS-->
<script src="{{asset('KAdmin-Dark/script/highcharts.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/data.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/drilldown.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/exporting.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/highcharts-more.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/charts-highchart-pie.js')}}"></script>
<script src="{{asset('KAdmin-Dark/script/charts-highchart-more.js')}}"></script>
<!--CORE JAVASCRIPT-->
<script src="{{asset('KAdmin-Dark/script/main.js')}}"></script>
